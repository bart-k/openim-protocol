...
var file_msg_msg_proto_rawDesc = []byte{
	...
	0x9c, 0x01, 0x0a, 0x0b, 0x53, 0x65, 0x6e, 0x64, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x73, 0x70, 0x12,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x73, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12,
	0x2d, 0x0a, 0x06, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x15, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x69, 0x6d, 0x2e, 0x73, 0x64, 0x6b, 0x77, 0x73, 0x2e, 0x4d,
	0x73, 0x67, 0x44, 0x61, 0x74, 0x61, 0x52, 0x06, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x22, 0x2d,
...
var file_msg_msg_proto_depIdxs = []int32{
	...
	92,  // 6: openim.msg.MsgDataToModifyByMQ.messages:type_name -> openim.sdkws.MsgData
	23,  // 7: openim.msg.ClearConversationsMsgReq.deleteSyncOpt:type_name -> openim.msg.DeleteSyncOpt
	23,  // 8: openim.msg.UserClearAllMsgReq.deleteSyncOpt:type_name -> openim.msg.DeleteSyncOpt
	23,  // 9: openim.msg.DeleteMsgsReq.deleteSyncOpt:type_name -> openim.msg.DeleteSyncOpt
	83,  // 10: openim.msg.SeqsInfoResp.maxSeqs:type_name -> openim.msg.SeqsInfoResp.MaxSeqsEntry
	84,  // 11: openim.msg.GetMsgByConversationIDsReq.maxSeqs:type_name -> openim.msg.GetMsgByConversationIDsReq.MaxSeqsEntry
	85,  // 12: openim.msg.GetMsgByConversationIDsResp.msgDatas:type_name -> openim.msg.GetMsgByConversationIDsResp.MsgDatasEntry
	86,  // 13: openim.msg.GetConversationsHasReadAndMaxSeqResp.seqs:type_name -> openim.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntry
	93,  // 14: openim.msg.GetActiveUserReq.pagination:type_name -> openim.sdkws.RequestPagination
	94,  // 15: openim.msg.ActiveUser.user:type_name -> openim.sdkws.UserInfo
	87,  // 16: openim.msg.GetActiveUserResp.dateCount:type_name -> openim.msg.GetActiveUserResp.DateCountEntry
	45,  // 17: openim.msg.GetActiveUserResp.users:type_name -> openim.msg.ActiveUser
	93,  // 18: openim.msg.GetActiveGroupReq.pagination:type_name -> openim.sdkws.RequestPagination
	95,  // 19: openim.msg.ActiveGroup.group:type_name -> openim.sdkws.GroupInfo
	88,  // 20: openim.msg.GetActiveGroupResp.dateCount:type_name -> openim.msg.GetActiveGroupResp.DateCountEntry
	48,  // 21: openim.msg.GetActiveGroupResp.groups:type_name -> openim.msg.ActiveGroup
	93,  // 22: openim.msg.SearchMessageReq.pagination:type_name -> openim.sdkws.RequestPagination
	54,  // 23: openim.msg.SearchChatLog.chatLog:type_name -> openim.msg.ChatLog
	92,  // 24: openim.msg.SearchedMsgData.msgData:type_name -> openim.sdkws.MsgData
	51,  // 25: openim.msg.SearchMessageResp.chatLogs:type_name -> openim.msg.SearchChatLog
	92,  // 26: openim.msg.batchSendMessageReq.msgData:type_name -> openim.sdkws.MsgData
	96,  // 27: openim.msg.ClearMsgReq.conversations:type_name -> openim.conversation.Conversation
	65,  // 28: openim.msg.GetSeqMessageReq.conversations:type_name -> openim.msg.ConversationSeqs
	97,  // 29: openim.msg.GetSeqMessageReq.order:type_name -> openim.sdkws.PullOrder
	89,  // 30: openim.msg.GetSeqMessageResp.msgs:type_name -> openim.msg.GetSeqMessageResp.MsgsEntry
	90,  // 31: openim.msg.GetSeqMessageResp.notificationMsgs:type_name -> openim.msg.GetSeqMessageResp.NotificationMsgsEntry
	69,  // 32: openim.msg.GetActiveConversationResp.conversations:type_name -> openim.msg.ActiveConversation
	91,  // 33: openim.msg.GetLastMessageResp.msgs:type_name -> openim.msg.GetLastMessageResp.MsgsEntry
	92,  // 34: openim.msg.GetMsgByConversationIDsResp.MsgDatasEntry.value:type_name -> openim.sdkws.MsgData
	42,  // 35: openim.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntry.value:type_name -> openim.msg.Seqs
	98,  // 36: openim.msg.GetSeqMessageResp.MsgsEntry.value:type_name -> openim.sdkws.PullMsgs
	98,  // 37: openim.msg.GetSeqMessageResp.NotificationMsgsEntry.value:type_name -> openim.sdkws.PullMsgs
	92,  // 38: openim.msg.GetLastMessageResp.MsgsEntry.value:type_name -> openim.sdkws.MsgData
	99,  // 39: openim.msg.msg.GetMaxSeq:input_type -> openim.sdkws.GetMaxSeqReq
	34,  // 40: openim.msg.msg.GetMaxSeqs:input_type -> openim.msg.GetMaxSeqsReq
	35,  // 41: openim.msg.msg.GetHasReadSeqs:input_type -> openim.msg.GetHasReadSeqsReq
	37,  // 42: openim.msg.msg.GetMsgByConversationIDs:input_type -> openim.msg.GetMsgByConversationIDsReq
	39,  // 43: openim.msg.msg.GetConversationMaxSeq:input_type -> openim.msg.GetConversationMaxSeqReq
	100, // 44: openim.msg.msg.PullMessageBySeqs:input_type -> openim.sdkws.PullMessageBySeqsReq
	66,  // 45: openim.msg.msg.GetSeqMessage:input_type -> openim.msg.GetSeqMessageReq
	50,  // 46: openim.msg.msg.SearchMessage:input_type -> openim.msg.SearchMessageReq
	6,   // 47: openim.msg.msg.SendMsg:input_type -> openim.msg.SendMsgReq
	63,  // 48: openim.msg.msg.SetUserConversationsMinSeq:input_type -> openim.msg.SetUserConversationsMinSeqReq
	24,  // 49: openim.msg.msg.ClearConversationsMsg:input_type -> openim.msg.ClearConversationsMsgReq
	26,  // 50: openim.msg.msg.UserClearAllMsg:input_type -> openim.msg.UserClearAllMsgReq
	28,  // 51: openim.msg.msg.DeleteMsgs:input_type -> openim.msg.DeleteMsgsReq
	32,  // 52: openim.msg.msg.DeleteMsgPhysicalBySeq:input_type -> openim.msg.DeleteMsgPhysicalBySeqReq
	30,  // 53: openim.msg.msg.DeleteMsgPhysical:input_type -> openim.msg.DeleteMsgPhysicalReq
	8,   // 54: openim.msg.msg.SetSendMsgStatus:input_type -> openim.msg.SetSendMsgStatusReq
	10,  // 55: openim.msg.msg.GetSendMsgStatus:input_type -> openim.msg.GetSendMsgStatusReq
	15,  // 56: openim.msg.msg.RevokeMsg:input_type -> openim.msg.RevokeMsgReq
	17,  // 57: openim.msg.msg.MarkMsgsAsRead:input_type -> openim.msg.MarkMsgsAsReadReq
	19,  // 58: openim.msg.msg.MarkConversationAsRead:input_type -> openim.msg.MarkConversationAsReadReq
	21,  // 59: openim.msg.msg.SetConversationHasReadSeq:input_type -> openim.msg.SetConversationHasReadSeqReq
	41,  // 60: openim.msg.msg.GetConversationsHasReadAndMaxSeq:input_type -> openim.msg.GetConversationsHasReadAndMaxSeqReq
	44,  // 61: openim.msg.msg.GetActiveUser:input_type -> openim.msg.GetActiveUserReq
	47,  // 62: openim.msg.msg.GetActiveGroup:input_type -> openim.msg.GetActiveGroupReq
	57,  // 63: openim.msg.msg.GetServerTime:input_type -> openim.msg.GetServerTimeReq
	59,  // 64: openim.msg.msg.ClearMsg:input_type -> openim.msg.ClearMsgReq
	61,  // 65: openim.msg.msg.DestructMsgs:input_type -> openim.msg.DestructMsgsReq
	68,  // 66: openim.msg.msg.GetActiveConversation:input_type -> openim.msg.GetActiveConversationReq
	71,  // 67: openim.msg.msg.AppendStreamMsg:input_type -> openim.msg.AppendStreamMsgReq
	73,  // 68: openim.msg.msg.GetStreamMsg:input_type -> openim.msg.GetStreamMsgReq
	75,  // 69: openim.msg.msg.SetUserConversationMaxSeq:input_type -> openim.msg.SetUserConversationMaxSeqReq
	77,  // 70: openim.msg.msg.SetUserConversationMinSeq:input_type -> openim.msg.SetUserConversationMinSeqReq
	79,  // 71: openim.msg.msg.GetLastMessageSeqByTime:input_type -> openim.msg.GetLastMessageSeqByTimeReq
	81,  // 72: openim.msg.msg.GetLastMessage:input_type -> openim.msg.GetLastMessageReq
	101, // 73: openim.msg.msg.GetMaxSeq:output_type -> openim.sdkws.GetMaxSeqResp
	36,  // 74: openim.msg.msg.GetMaxSeqs:output_type -> openim.msg.SeqsInfoResp
	36,  // 75: openim.msg.msg.GetHasReadSeqs:output_type -> openim.msg.SeqsInfoResp
	38,  // 76: openim.msg.msg.GetMsgByConversationIDs:output_type -> openim.msg.GetMsgByConversationIDsResp
	40,  // 77: openim.msg.msg.GetConversationMaxSeq:output_type -> openim.msg.GetConversationMaxSeqResp
	102, // 78: openim.msg.msg.PullMessageBySeqs:output_type -> openim.sdkws.PullMessageBySeqsResp
	67,  // 79: openim.msg.msg.GetSeqMessage:output_type -> openim.msg.GetSeqMessageResp
	53,  // 80: openim.msg.msg.SearchMessage:output_type -> openim.msg.SearchMessageResp
	7,   // 81: openim.msg.msg.SendMsg:output_type -> openim.msg.SendMsgResp
	64,  // 82: openim.msg.msg.SetUserConversationsMinSeq:output_type -> openim.msg.SetUserConversationsMinSeqResp
	25,  // 83: openim.msg.msg.ClearConversationsMsg:output_type -> openim.msg.ClearConversationsMsgResp
	27,  // 84: openim.msg.msg.UserClearAllMsg:output_type -> openim.msg.UserClearAllMsgResp
	29,  // 85: openim.msg.msg.DeleteMsgs:output_type -> openim.msg.DeleteMsgsResp
	33,  // 86: openim.msg.msg.DeleteMsgPhysicalBySeq:output_type -> openim.msg.DeleteMsgPhysicalBySeqResp
	31,  // 87: openim.msg.msg.DeleteMsgPhysical:output_type -> openim.msg.DeleteMsgPhysicalResp
	9,   // 88: openim.msg.msg.SetSendMsgStatus:output_type -> openim.msg.SetSendMsgStatusResp
	11,  // 89: openim.msg.msg.GetSendMsgStatus:output_type -> openim.msg.GetSendMsgStatusResp
	16,  // 90: openim.msg.msg.RevokeMsg:output_type -> openim.msg.RevokeMsgResp
	18,  // 91: openim.msg.msg.MarkMsgsAsRead:output_type -> openim.msg.MarkMsgsAsReadResp
	20,  // 92: openim.msg.msg.MarkConversationAsRead:output_type -> openim.msg.MarkConversationAsReadResp
	22,  // 93: openim.msg.msg.SetConversationHasReadSeq:output_type -> openim.msg.SetConversationHasReadSeqResp
	43,  // 94: openim.msg.msg.GetConversationsHasReadAndMaxSeq:output_type -> openim.msg.GetConversationsHasReadAndMaxSeqResp
	46,  // 95: openim.msg.msg.GetActiveUser:output_type -> openim.msg.GetActiveUserResp
	49,  // 96: openim.msg.msg.GetActiveGroup:output_type -> openim.msg.GetActiveGroupResp
	58,  // 97: openim.msg.msg.GetServerTime:output_type -> openim.msg.GetServerTimeResp
	60,  // 98: openim.msg.msg.ClearMsg:output_type -> openim.msg.ClearMsgResp
	62,  // 99: openim.msg.msg.DestructMsgs:output_type -> openim.msg.DestructMsgsResp
	70,  // 100: openim.msg.msg.GetActiveConversation:output_type -> openim.msg.GetActiveConversationResp
	72,  // 101: openim.msg.msg.AppendStreamMsg:output_type -> openim.msg.AppendStreamMsgResp
	74,  // 102: openim.msg.msg.GetStreamMsg:output_type -> openim.msg.GetStreamMsgResp
	76,  // 103: openim.msg.msg.SetUserConversationMaxSeq:output_type -> openim.msg.SetUserConversationMaxSeqResp
	78,  // 104: openim.msg.msg.SetUserConversationMinSeq:output_type -> openim.msg.SetUserConversationMinSeqResp
	80,  // 105: openim.msg.msg.GetLastMessageSeqByTime:output_type -> openim.msg.GetLastMessageSeqByTimeResp
	82,  // 106: openim.msg.msg.GetLastMessage:output_type -> openim.msg.GetLastMessageResp
